...
public class ProjectAdminAdapter extends ArrayAdapter<Projects> {
    private Context context;
    private List<Projects> projects;
    public ProjectAdminAdapter(Context context,List<Projects> list)
    {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        noOfAnnotations.setText(projects.get(position).getRemainingCount()+"/"+projects.get(position).getTotalCount());
